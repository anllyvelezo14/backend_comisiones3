...
// const auth = require('./middlerwares/auth')
>>>>>>> 1d0af2d19141c0d2f0514b1f5947b9cdea40eef9
...
// // , auth
// // , ShowAllDocsCumpl.showAll
// , DocumentoController.all);

// router.get('/api/cumplidos'
// // , auth
// // , ShowAllDocsCumpl.showAll
// , CumplidoController.all);

// router.get('/api/estados'
// // , auth
// , EstadoController.all);

// router.get('/api/comisiones-estados'
// // , auth
// // , ComisionHasEstadoPolicy.showAll
// , ComisionHasEstadoController.all);
